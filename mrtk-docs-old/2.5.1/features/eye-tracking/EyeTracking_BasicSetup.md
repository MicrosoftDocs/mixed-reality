...
![MRTK setup configuration](../images/eye-tracking/mrtk_setup_configure.jpg)
...
![MRTK profile settings](../images/eye-tracking/mrtk_setup_configprofile.jpg)
...
1. **Enable simulated eye tracking**:
    ...
    ![MRTK eyes simulate setup](../images/eye-tracking/mrtk_setup_eyes_simulate.jpg)
