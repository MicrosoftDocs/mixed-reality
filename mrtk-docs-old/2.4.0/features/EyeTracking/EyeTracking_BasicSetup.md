...
![MRTK Setup config profiles](../Images/EyeTracking/mrtk_setup_configprofile.jpg)
...
![MRTK setup eyes data provider](../Images/EyeTracking/mrtk_setup_eyes_dataprovider.jpg)
