...
#### Windows 10, version 2004 (May 2020 Update) ####
   ...
   |------------------|-----------------------|---------------------------------------------------------------|
   | [10.0.19041.2037](https://www.microsoft.com/en-us/download/details.aspx?id=102527)  | December 10th, 2020  | Compatible with Windows 10, version 1903, and newer.<br/><ul><li>New controller firmware for the HP Controller to address an issue where some controllers have non-functioning triggers.</li>|
...
| Version          | Release Date          | Major changes                                                 |
   |------------------|-----------------------|---------------------------------------------------------------|
   | [10.0.19041.2034](https://www.microsoft.com/en-us/download/details.aspx?id=102155)  | September 16th, 2020      | Initial public release of the driver for the new HP Motion Controllers. Compatible with Windows 10, version 1903, and newer. This driver is compatible only with new HP Motion Controllers.  |
