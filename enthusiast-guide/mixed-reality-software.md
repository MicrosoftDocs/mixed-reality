...
#### Windows 10, version 1809 and newer ####
   ...
   | 2000.19081.1301.0  | September 23, 2019    | <ul><li>Addresses an issue were headsets with hardware problems were shown an incorrect error message. Users that received a 1-4 error code on previous versions may now receive a more specific error code for their device state.</li></ul>  |
