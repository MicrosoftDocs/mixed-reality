...
2. Launch **Feedback Hub** on desktop with the HMD connected. You can download and install the latest [Feedback Hub](https://www.microsoft.com/p/feedback-hub/9nblggh4r32n?rtc=1&activetab=pivot:overviewtab) app from Microsoft Store.
