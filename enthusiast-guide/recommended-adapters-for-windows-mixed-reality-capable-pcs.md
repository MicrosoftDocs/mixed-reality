...
Devices shipped in 2017 or earlier need an adapter for controllers. If your PC doesn't include Bluetooth for pairing [Windows Mixed Reality motion controllers](controllers-in-wmr.md), you can use an adapter like the Plugable USB Bluetooth 4.0 Low Energy Micro Adapter.
