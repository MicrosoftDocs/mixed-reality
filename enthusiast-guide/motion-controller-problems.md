...
If your [motion controllers](controllers-in-wmr.md) aren’t working, aren't connecting, or if you don’t see an image of the controllers when you’re wearing your headset, try the following:
...
If your PC doesn’t have Bluetooth, use Plugable USB Bluetooth 4.0 Low Energy Micro Adapter.
