...
| [Scene understanding (planes, meshes)](scene-understanding.md)<p>*HoloLens 2 only*</p> | <p>**`MSFT_preview` extension in preview runtime**: June 2020 *(planned)*</p><p>**`MSFT` extension in preview runtime**: July 2020 *(planned)*</p> |
