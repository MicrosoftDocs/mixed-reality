...
| [Hand interaction<br />(grip/aim pose, air-tap, grasp)](hands-and-tools.md) | **`MSFT` extension released:**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_interaction">XR_MSFT_hand_interaction</a></code> *(HoloLens 2 only)* |
| [Hand articulation + hand mesh](hands-and-tools.md) | **`MSFT_preview` extensions in [preview runtime version 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_preview">XR_MSFT_hand_tracking_preview</a></code> *(HoloLens 2 only)*<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_mesh_preview">XR_MSFT_hand_tracking_mesh_preview</a></code> *(HoloLens 2 only)*<p>**`MSFT` or `EXT` extension in preview runtime**: May 2020 *(planned)*</p> |
| [Eye gaze](eye-tracking.md) | **`EXT` extension in [preview runtime version 2003](openxr-getting-started.md#using-preview-extensions)**:<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_EXT_eye_gaze_interaction" target="_blank">XR_EXT_eye_gaze_interaction</a></code> *(HoloLens 2 only)*<p>**Support in stable runtime**: May 2020 *(planned)*</p> |
| Interop with other HoloLens SDKs (e.g. [QR](qr-code-tracking.md)) | **`MSFT_preview` extension in [preview runtime version 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_spatial_graph_bridge_preview">XR_MSFT_spatial_graph_bridge_preview</a></code> *(HoloLens 2 only)*<p>**`MSFT` extension in preview runtime**: May 2020 *(planned)*</p> |
| [Mixed Reality Capture<br />(third render from PV camera)](mixed-reality-capture-for-developers.md#render-from-the-pv-camera-opt-in) | **`MSFT_preview` extensions in [preview runtime version 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_secondary_view_configuration_preview">XR_MSFT_secondary_view_configuration_preview</a></code> *(HoloLens 2 only)*<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_first_person_observer_preview">XR_MSFT_first_person_observer_preview</a></code> *(HoloLens 2 only)*<p>**`MSFT` extension in preview runtime**: June 2020 *(planned)*</p> |
| [Motion controller render models](motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview` extension in [preview runtime version 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code> *(HoloLens 2 only)*<p>**`MSFT` extension in preview runtime**: July 2020 *(planned)*</p> |
