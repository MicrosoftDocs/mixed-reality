...
## See also
* [Scripts and prefabs for App bar and bounding box on Mixed Reality Toolkit](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/master/Assets/HoloToolkit-Examples/UX/Readme/README_BoundingBoxGizmoExample.md)
