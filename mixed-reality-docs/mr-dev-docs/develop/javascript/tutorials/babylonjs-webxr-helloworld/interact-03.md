...
1. Enable the Windows Mixed Reality Simulator by following the steps in this [guide](https://docs.microsoft.com/en-us/windows/mixed-reality/develop/platform-capabilities-and-apis/using-the-windows-mixed-reality-simulator#enabling-the-windows-mixed-reality-simulator) if you have not done so in the past.
