...
> [!CAUTION]
> You can only track QR codes using the HoloLens OS hardware and software resources. If you needs something special, you can access the device's [webcam](unreal-hololens-camera.md) and process images using a third party image recognition library.
