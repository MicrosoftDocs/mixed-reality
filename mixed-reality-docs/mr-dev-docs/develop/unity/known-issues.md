...
| HL2 app using URP has worse render performance in Unity 2021 comparing to Unity 2020. | **Investigating:**<br />2022/04/18 | Unity 2021.\*.\* with <br/> URP 12.1.4 and later | Either avoid URP in Unity&nbsp;2021 or use Unity&nbsp;2020.LTS |
