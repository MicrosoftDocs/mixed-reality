...
| [Configuring your project for VR and Windows Mixed Reality headsets](./new-openxr-project-with-mrtk.md) | Learn how to build applications that render digital content on holographic and VR display devices |
