...
<!-- You might need to include this:

The **MRTK Project Configurator** appears and asks you to enable an XR pipeline. 

Select **XR SKD/XR Management**. 

--or--

Select "Skip" or "Skip for now." -->
...
1. In the **OpenXR Project Validation** window, there are two issues listed. Select the **Fix** button for the bottom one.
