...
![Screenshot of Build Settings window open in the unity editor with PC, Mac & Standalone platform highlighted](images/wmr-configure-img-1.png)
...
![Screenshot of Build Settings window open in unity editor with Universal Windows Platform highlighted](images/wmr-configure-img-2.png)
...
![Screenshot of Project Settings window open in unity editor with XR Plugin management highlighted](images/wmr-configure-img-3.png)

2. Select **Install XR Plugin Management**

![Screenshot of Package manager window open in unity editor](images/wmr-configure-img-4.png)
...
![Screenshot of Project settings window open in unity editor with XR Plugin management highlighted](images/wmr-configure-img-5.png)
...
![Screenshot of Project settings window open in unity editor with Windows Mixed Reality section highlighted](images/wmr-configure-img-6.png)
...
![Screenshot of Project settings window open in unity editor with Player settings section highlighted](images/wmr-configure-img-7.png)
...
![Screenshot of Project settings window open in unity editor with quality settings section highlighted](images/wmr-configure-img-8.png)<br>
...
![Screenshot of the inspector tab open in the Unity editor](images/wmr-configure-img-9.png)<br>
*Unity camera settings*
