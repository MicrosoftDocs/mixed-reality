...
> [!NOTE]
> These anchors are to be saved and loaded on the same device. Cross-device anchors are supported through [Azure Spatial Anchors](https://docs.microsoft.com/windows/mixed-reality/develop/unity/shared-experiences-in-unity#azure-spatial-anchors).
