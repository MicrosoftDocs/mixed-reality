...
You can also leverage the REST APIs to monitor and test mitigation levels and thermal scores.  More information can be found on the [Device Portal API Reference](../advanced-concepts/device-portal-api-reference#holographic-thermal)
