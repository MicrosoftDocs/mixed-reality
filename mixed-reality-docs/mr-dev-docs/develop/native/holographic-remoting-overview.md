...
> [!NOTE]
> When developing a remote application either the Windows Mixed Reality API or the OpenXR API has to be used. Mixing both APIs withing the same application is not supported.
