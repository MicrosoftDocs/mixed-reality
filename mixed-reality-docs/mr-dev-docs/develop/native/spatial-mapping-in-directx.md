...
description: Learn how to implement spatial mapping in your DirectX app, including the spatial mapping sample application that comes with the Universal Windows Platform SDK.
author: mikeriches
ms.author: mriches
ms.date: 08/04/2020
ms.topic: article
