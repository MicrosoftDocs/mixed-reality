...
Welcome to the Mixed Reality Dev Days, tailored to a digital experience in 2D and 3D with [AltspaceVR](/windows/mixed-reality/altspace-vr/)! Here you can hear from Microsoft leaders, learn from experts, and connect with the mixed reality developer community. 
...
| [Azure Kinect Body Tracking Unity Integration](/shows/Mixed-Reality/Azure-Kinect-Body-Tracking-Unity-Integration) | Angus Antler | Learn how to drive characters in Unity using the Azure Kinect Body Tracking SDK. |
