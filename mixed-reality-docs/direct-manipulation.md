...
|:-------- | :-------| :--------| :------------|
| Direct manipulation  with hands | ❌ Not supported | ✔️ Recommended | ➕ An alternative [point and commit](https://review.docs.microsoft.com/en-us/windows/mixed-reality/point-and-commit?branch=master) is recommended.
