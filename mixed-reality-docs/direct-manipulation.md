...
<tr>
<td>Direct manipulation (near interaction)</td><td style="text-align: center;">:x: Not supported</td><td style="text-align: center;">✔️ Recommended (first)</td><td>:heavy_plus_sign: An alternate option but <a href="TBD-fill-in-file-name.md">Pointing and commit (far interaction)</a> is recommended</td>
</tr>
</table>
