...
* On previous version pose prediction was completely done on the player side by the Holographic Remoting player. Starting with version 2.2.0 Holographic Remoting has full time synchronization and prediction is fully done by the remote application. Users should expect improved hologram stability under difficult network situations.
