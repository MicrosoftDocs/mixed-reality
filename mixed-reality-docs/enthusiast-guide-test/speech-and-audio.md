...
* Make sure your audio headset is completely plugged into the audio jack. The Acer headset in particular may require more care to ensure the audio headset is plugged in.
...
* If you open and play music from a background-capable music app (like Groove Music) in your home and then open an immersive VR experience like a game, the sound from the music app will crossfade from spatial sound to stereo. It may appear louder because there is no longer any distance between you and the sound. 
