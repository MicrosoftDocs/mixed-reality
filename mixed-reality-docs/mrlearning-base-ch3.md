...
>Note: When you add the component you will notice that the system adds the orbital script and the solver handler script, which is a required component. 
