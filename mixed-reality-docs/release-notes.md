...
<table>
  ...
  <tr>
    <td>Photo and video sync through OneDrive app</td><td>Your photos and videos from HoloLens will now sync via the OneDrive app from the Store instead of directly through the Photos app.</td><td>To setup, download and launch the OneDrive app from the Store. On first run you should be prompted to automatically upload your photos to OneDrive, or you can find the option in the app settings.</td>
  </tr>
</table>
