...
| | |
| ----------- | ----------- |
| <a href="https://channel9.msdn.com/Shows/Docs-Mixed-Reality/Intro-to-MRTK-Unity" target="_blank">![Intro to MRTK-Unreal for HoloLens 2](images/MRDevDays_Session4.png)</a> | In this talk, we'll provide an overview of the features provided in Unreal Engine 4 and MRTK for Unreal, and how to use them to build epic experiences for HoloLens 2. |
