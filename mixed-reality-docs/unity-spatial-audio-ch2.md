...
In this step, you'll spatialize the audio feedback for the button. For related design suggestions, see [spatial sound design](https://docs.microsoft.com/en-us/windows/mixed-reality/spatial-sound-design). 
