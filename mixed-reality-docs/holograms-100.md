...
If you do not see the **Windows Store** icon, then check if you made sure to select the Windows Store .NET Scripting Backend prior to installation. If not, you may need to reinstall Unity with the correct Windows installation.
