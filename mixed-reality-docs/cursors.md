...
A cursor, or indicator of your current [gaze](gaze.md) vector, provides continuous feedback for the user to understand what the HoloLens understands about their intentions.
