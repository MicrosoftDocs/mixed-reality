...
>[!NOTE]
> If the wrong network is selected during OOBE the device will need to be fully reset. Instructions can be found [here.](https://docs.microsoft.com//windows/mixed-reality/reset-or-recover-your-hololens#perform-a-full-device-recovery) 
