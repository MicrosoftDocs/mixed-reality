...
> [!NOTE]
> More guidance specific to the HoloLens 2 emulator [coming soon](index.md#news-and-notes).
...
| ![Visual Studio logo](images/visualstudio_logo.png)<br><br><a href="https://visualstudio.microsoft.com/downloads/" target="_blank">**Visual Studio 2017**<br>(Install link)</a> | Fully-featured integrated development environment (IDE) for Windows and more. You'll use Visual Studio to write code, debug, test, and deploy. | **Additional workloads to install:** <ul><li>Universal Windows Platform development</ul>**Note about Unity:** Unless you're intentionally trying to install a newer (non-LTS) version of Unity for a specific purpose, we recommend *not* installing the Unity workload as part of Visual Studio installation, and instead installing the 2018.3 LTS stream of Unity as noted below.<br> <br> The Windows 10 SDK is included when you install Visual Studio. You can also manually download and install <a href="https://developer.microsoft.com/windows/downloads/windows-10-sdk" target="_blank">the latest version of the SDK</a>.<br> <br>**Note:** There are some known issues with mixed reality development in Visual Studio 2019 at the moment.  For now, we recommend that you continue using Visual Studio 2017. |
| ![Visual Studio logo](images/HoloLensIcon.jpg)<br><br><a href="https://go.microsoft.com/fwlink/?linkid=2065980" target="_blank">**HoloLens (1st gen) Emulator and Holographic Project Templates**<br>(Install link: 10.0.17763.253)</a> | The emulator allows you to run apps on a HoloLens (1st gen) virtual machine image without a physical HoloLens.<br> <br> This package also includes holographic DirectX project templates for Visual Studio. | See [Using the HoloLens emulator](using-the-hololens-emulator.md) for more information on getting started with the emulator.<br> <br> **Your system must support Hyper-V** for the emulator installation to succeed. Please reference the System Requirements section below for the details. If desired, you can select to install only the templates without the emulator.<br> <br> More guidance specific to the HoloLens 2 emulator is [coming soon](index.md#news-and-notes). |
| ![Unity logo](images/unity_logo.png)<br><br><a href="https://unity3d.com/get-unity/download" target="_blank">**Unity 2018.3**<br>(Install link)</a> | The Unity game engine is the easiest way to create mixed reality experiences, with built-in support for Windows Mixed Reality features. | We typically recommend the Unity LTS stream as the best version with which to start new projects, updating to its latest revision to pick up the latest fixes.<br> <br> Current recommendation is to use **Unity 2018.3.x**, which is required for MRTK V2 below. <br> <br> Some developers may want to use a different version of Unity for specific reasons. For those cases, Unity supports side-by-side installs of different versions. |
| ![MRTK logo](images/MRTKIcon.jpg)<br><br><a href="https://github.com/Microsoft/MixedRealityToolkit-Unity/releases/tag/v2.0.0-RC1" target="_blank">**Mixed Reality Toolkit (MRTK V2) for Unity**</a> | MRTK v2 for Unity is an open source cross-platform development kit for mixed reality applications.<br><br> MRTK v2 is intended to accelerate development of applications targeting Microsoft HoloLens, Windows Mixed Reality immersive (VR) headsets and the OpenVR platform. The project is aimed at reducing the barriers to entry to create mixed reality applications and contributing back to the community as we all grow. | Learn more about MRTK v2 by visiting the project's <a href="https://github.com/Microsoft/MixedRealityToolkit-Unity/wiki" target="_blank">GitHub wiki</a>. |
...
To get started with the HoloLens (1st gen) emulator, see [Using the HoloLens emulator](using-the-hololens-emulator.md).
