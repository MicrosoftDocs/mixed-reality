...
<li>The LTS (Long Term Support) stream is the best version with which to start new projects, and migrate forward to, in order to pick up the latest stability fixes.</li> <li>When installing, make sure to select the Windows Store .NET Scripting Backend (you may install the docs as well). </li>
</ul></td>
</tr><tr>
