...
| [Visual Studio 2017](https://visualstudio.microsoft.com/downloads/) | Fully-featured integrated development environment (IDE) for Windows and more. You'll use Visual Studio to write code, debug, test, and deploy. | **Additional workloads to install:** <ul><li>lorem ipsum.<li>lorem ipsum.<li>lorem ipsum</ul><**Note:** unless you're intentionally trying to install a newer (non-LTS) version of Unity for a specific purpose, we recommend *not* installing the Unity workload as part of Visual Studio installation, and instead installing the LTS stream of Unity as noted below. |
