...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [![DirectX app templates](images/visualstudio-small_logo.png)](https://marketplace.visualstudio.com/items?itemName=WindowsMixedRealityteam.WindowsMixedRealityAppTemplatesVSIX)<br>
