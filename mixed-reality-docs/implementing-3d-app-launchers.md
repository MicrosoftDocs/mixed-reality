...
First, locate the app package manifest in your current project. By default the manifest will be named Package.appxmanifest. If you're using Visual Studio then left click it in your solution viewer and select "View source" to open the xml for editing. At the top of the manifest add the uap5 schema and include it as an ignorable namespace:
