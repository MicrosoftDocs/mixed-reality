---
title: Sample App Launcher Shortcut Creation
description: How to create a start menu shortcut for an immersive applicaiton in C++
author: thmignon
ms.author: thmignon
ms.date: 07/05/2018
ms.topic: article
keywords: 3D, logo, icon, modeling, launcher, 3D launcher, tile, live cube, deep link
---
