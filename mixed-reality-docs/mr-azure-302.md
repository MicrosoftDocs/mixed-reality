...
description: Complete this course to learn how to recognize visual content within a provided image, using Azure Computer Vision within a mixed reality application.
author: drneil
ms.author: v-arood
ms.date: 07/04/2018
...
Recognition results will be displayed as descriptive tags. You can use this Service without the need of training a machine learning model.
...
8. Click the **Go to resource** button in the notification to explore your new Service instance. You will be taken to your new Computer Vision API service instance. 
    ...
    ![Your new Computer Vision API service](images/AzureLabs-Lab2-05.png)
