...
* Download the [files](https://github.com/Microsoft/HolographicAcademy/archive/Holograms-210-Gaze.zip) required by the project. Requires Unity 2017.2 or later.
    * If you still need older Unity support or would like to access the previous version of this Academy course, please see the [Holograms 210 archive](holograms-210-archive.md).
...
4. Enter location as the **Gaze** folder you previously unarchived.
...
![](images/holograms210-interactible.png)
