...
![Enabling developer mode in the Setting app for Windows Holographic](images/deviceportalsettings.png)
...
![Set up access to Windows Device Portal](images/windows-device-portal-credentials-reset-page-1000px.png)
...
![Windows Device Portal home page on Microsoft HoloLens](images/windows-device-portal-home-page-1000px.png)
...
![3D View page in Windows Device Portal on Microsoft HoloLens](images/3dview-1000px.png)
...
![Mixed Reality Capture page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-mixed-reality-capture-page-1000px.png)
...
![Performance Tracing page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-performance-tracing-page-1000px.png)
...
![Processes page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-running-processes-page-1000px.png)

Shows details about currently running processes. This includes both apps and system processes.

### System Performance

![System Performance page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-system-performance-page-1000px.png)
...
![Apps page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-apps-page-1000px.png)
...
![App Crash Dumps page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-dev-apps-crash-dumps-page-1000px.png)
...
![File Explorer page in Windows Device Portal on Microsoft HoloLens](images/fileexplorer-1000px.png)
...
***Available only with the Microsoft HoloLens Commercial Suite.*** ![Kiosk Mode page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-kiosk-mode-page-1000px.png)
...
![Logging page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-logging-page-1000px.png)
...
![Simulation page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-simulation-page-1000px.png)
...
![Networking page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-networking-page-1000px.png)
...
![Virtual Input page in Windows Device Portal on Microsoft HoloLens](images/windows-device-portal-virtual-input-page-1000px.png)
