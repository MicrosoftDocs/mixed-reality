...
7. In the Project tab, underneath the Assets folder, click on ASAmoduleAssets. Once selected, you will see two prefabs: ButtonParent and ParentAnchor.

![module2chapter1step7im](images/module2chapter1step7im.PNG)

8. Drag both prefabs into the scene. 

![module2chapter1step8im](images/module2chapter1step8im.PNG)

9. Double click on the parent anchor to select it. You might need to adjust your view to see the entire scene. Adjust your scene as needed.
