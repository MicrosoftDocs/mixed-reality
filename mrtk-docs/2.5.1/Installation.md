...
<img src="../../mrtk-docs/2.5.1/features/Images/MRTK_UnitySetupPrompt.png" width="600">
...
1. Click the **Switch Platform** button
    ...
    <img src="../../mrtk-docs/2.5.1/features/Images/getting_started/SwitchPlatform.png" width="600">
...
* Learn about the UX controls available in MRTK in [UI and interaction building blocks](missing-docs/README.md#ux-building-blocks).
...
* Learn about the [MRTK's Tools](missing-docs/README.md#tools) that will empower your mixed reality design and development.
