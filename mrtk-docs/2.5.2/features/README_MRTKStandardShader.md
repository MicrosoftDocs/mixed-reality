...
![Material Gallery](Images/MRTKStandardShader/MRTK_MaterialGallery.jpg)
...
![Material Comparison](Images/MRTKStandardShader/MRTK_StandardMaterialComparison.gif)
...
![Material Inspector](Images/MRTKStandardShader/MRTK_MaterialInspector.jpg)
...
![Rendering Modes](Images/MRTKStandardShader/MRTK_RenderingModes.jpg)
...
![lwrp upgrade](Images/MRTKStandardShader/MRTK_LWRPUpgrade.jpg)
...
![scale mesh effect](Images/MRTKStandardShader/MRTK_ScaleMeshEffect.jpg)
...
![channel map example](Images/MRTKStandardShader/MRTK_ChannelMap.gif)
...
![texture combiner example](Images/MRTKStandardShader/MRTK_TextureCombiner.jpg)
...
![primitive clipping](Images/MRTKStandardShader/MRTK_PrimitiveClipping.gif)
...
<img src="Images/MRTKStandardShader/MRTK_MeshOutline.jpg" width="900" alt="MRTKMeshOutline">
...
<img src="Images/MRTKStandardShader/MRTK_OutlineMaterial.jpg" width="450" alt="MRTKOutline Material">
...
<img src="Images/MRTKStandardShader/MRTK_SmoothNormals.jpg" width="450" alt="SmoothNormals">
...
![stencil test](Images/MRTKStandardShader/MRTK_StencilTest.gif)

### Instanced color support

Instanced color support to give thousands of GPU instanced meshes unique material properties:

![instanced properties](Images/MRTKStandardShader/MRTK_InstancedProperties.gif)
...
![triplanar](Images/MRTKStandardShader/MRTK_TriplanarMapping.gif)
...
![albedo assignment](Images/MRTKStandardShader/MRTK_AlbedoAssignment.jpg)

Per pixel clipping textures, local edge based anti aliasing, and normal map scaling are supported.

![normal map scale](Images/MRTKStandardShader/MRTK_NormalMapScale.gif)
