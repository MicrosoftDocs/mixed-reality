...
> **Warning**
> Input simulation does not work when using Unity's XR Holographic Emulation > Emulation Mode = "Simulate in Editor." Unity's in-editor simulation will take control away from MRTK's input simulation. To use MRTK's input simulation, you will need to set XR Holographic Emulation to Emulation Mode = *"None"*.
