...
[`public abstract void SetValue(ThemeStateProperty property, int index, float percentage)`](xref:Microsoft.MixedReality.Toolkit.UI.InteractableThemeBase.SetValue%2A)
...
[`public abstract ThemePropertyValue GetProperty(ThemeStateProperty property)`](xref:Microsoft.MixedReality.Toolkit.UI.InteractableThemeBase.GetProperty%2A)
