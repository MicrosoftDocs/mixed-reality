...
Progress indicators implement the [`IProgressIndicator`](xref:Microsoft.MixedReality.Toolkit.UI.IProgressIndicator?view=mixed-reality-toolkit-unity-2020-dotnet-2.8.0&preserve-view=true) interface. This interface can be retrieved from a GameObject using `GetComponent`.
