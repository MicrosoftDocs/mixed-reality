...
1. Attach [Tap to Place](xref:Microsoft.MixedReality.Toolkit.Utilities.Solvers.TapToPlace?view=mixed-reality-toolkit-unity-2020-dotnet-2.8.0&preserve-view=true) to a game object with a collider
