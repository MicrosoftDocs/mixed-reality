...
Note: `Hand Coach`, `Tooltips`, `Object Collection`, `AppBar`, and `Progress Indicator` components do not yet exist in MRTK3. Additionally, `Toolbox` and optimized `Text Prefabs` are not implemented. This document will be updated as additional MRTK3 UX components are added
