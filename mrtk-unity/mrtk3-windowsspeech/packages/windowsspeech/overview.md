...
Please refer to the [Setup](../../../mrtk3-core/packages/core/subsystems/phraserecognitionsubsystem.md#setup) and [Using PhraseRecognitionSubsystem](../../../mrtk3-core/packages/core/subsystems/phraserecognitionsubsystem.md#using-phraserecognitionsubsystem) sections of the [`PhraseRecognitionSubsystem` doc](../../../mrtk3-core/packages/core/subsystems/phraserecognitionsubsystem.md). Note for `WindowsPhraseRecognitionSubsystem`, a configuration asset is not needed and the only capability needed in player settings is microphone.
